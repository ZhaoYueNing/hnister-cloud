...
CREATE TABLE `t_bbs_tier` (
  ...
  `theme_id` int(11) NOT NULL DEFAULT '-1' COMMENT '所在主题Id',
  `plate_id` int(11) NOT NULL DEFAULT '-1' COMMENT '所在板块Id',
  `post_time` datetime NOT NULL COMMENT '发表时间',
  PRIMARY KEY (`id`)
...
insert  into `t_bbs_tier`(`id`,`topic_id`,`content`,`number`,`username`,`type`,`status`,`reply_num`,`theme_id`,`plate_id`,`post_time`) values (1,11,'demo content',1,'buynow',1,1,0,1,5,'2018-04-24 15:40:42'),(2,11,'test content',2,'buynow',1,1,0,1,5,'2018-04-24 16:13:25');
...
CREATE TABLE `t_bbs_topic` (
  ...
  `max_tier_num` int(11) NOT NULL DEFAULT '1' COMMENT '最大楼层数量，用于插入楼层时获取楼层号',
  `status` int(11) NOT NULL DEFAULT '1' COMMENT '状态 1普通',
  `order_num` int(11) NOT NULL DEFAULT '100' COMMENT '用来排序，默认100',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8;

/*Data for the table `t_bbs_topic` */

insert  into `t_bbs_topic`(`id`,`plate_id`,`theme_id`,`title`,`post_time`,`username`,`reply`,`type`,`max_tier_num`,`status`,`order_num`) values (1,5,1,'这是一个测试帖子','2018-04-22 00:05:31','buynow96',0,1,1,1,100),(2,5,1,'这是一个测试帖子','2018-04-22 00:05:26','buynow96',0,1,1,1,100),(3,5,1,'这是一个测试帖子','2018-04-22 00:05:35','buynow96',0,1,1,1,100),(4,5,1,'这是一个测试帖子','2018-04-22 00:05:35','buynow96',0,1,1,1,100),(5,5,1,'这是一个测试帖子','2018-04-22 00:05:41','buynow96',0,1,1,1,100),(6,5,1,'demo','2018-04-22 17:36:37','buynow96',1,1,1,1,100),(7,5,1,'add','2018-04-22 17:51:45','buynow96',1,1,1,1,100),(8,5,1,'add','2018-04-22 17:51:55','buynow96',1,1,1,1,100),(9,5,1,'demo','2018-04-22 18:06:03','buynow',1,1,1,1,100),(10,5,1,'demo','2018-04-22 20:26:09','buynow',1,1,1,1,100),(11,5,1,'demo','2018-04-24 15:40:42','buynow',2,1,2,1,100);
...
insert  into `t_user`(`zlass_id`,`name`,`birth`,`gender`,`status`,`city`,`salt`,`password`,`username`,`create_time`,`avatar`,`type`,`specialty_id`,`college_id`,`grad`) values (NULL,'zhao',NULL,NULL,0,NULL,'1517134883545','0f92f2c1e04431ae8f22992c86648d98c19c3d90ef79e70edefa1c96cf99722c','buynow','2018-02-08 23:03:04','http://localhost:9528/static/images/avatar/default-avatar.jpg',1,NULL,NULL,NULL),(1,'赵岳宁',NULL,1,0,NULL,'560c5b22-d29e-4f1f-bab8-befdee4049ea','e901230f9757e1674a59fbdb310ddf9b11227857be0e2250c051fe30aa78b858','buynow96','2018-04-13 05:11:54',NULL,0,1,1,'2014'),(1,'demo',NULL,1,0,NULL,'01559d75-608a-46b1-9aec-71a574926502','8f3dd40c79cceedb183b4929b485c017c6090a54e6caeecefee26a4af6028d09','demo3333','2018-04-13 05:32:44',NULL,0,1,1,'2014'),(NULL,'zhao',NULL,1,0,'changsha','1516953677817','ac439b2a1b74e728f6a7ff34be3329d6a78a4d014489d4d1b798213233cb75ec','zhaoyuening','2018-01-26 16:01:36',NULL,0,NULL,NULL,NULL),(NULL,'zhao',NULL,NULL,0,NULL,'1516960175517','21e6056bcbd02e407b1e71d38fd8de52e50c697854dcdfa56cae8edd8320d498','zhaozhaozhao','2018-01-26 17:49:40',NULL,0,NULL,NULL,NULL),(NULL,'zhao',NULL,NULL,0,NULL,'1516962010803','438de76e78b8cc4dffbbedcd85ee8c64cefe80b4294e518cada9d1cdf1cae9d7','zhaozhaozhao2','2018-01-26 18:20:10',NULL,0,NULL,NULL,NULL);
