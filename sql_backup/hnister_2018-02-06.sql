...
# Database: hnister
# Generation Time: 2018-02-06 01:52:29 +0000
# ************************************************************
...
VALUES
	...
	(2,'login',2,'/hnister-security-service/user/login',0,NULL),
	(3,'user info',0,'/hnister-security-service/user/info',0,NULL),
	(4,'user logout',2,'/hnister-security-service/user/logout',0,NULL);
...
INSERT INTO `t_user` (`zlass_id`, `name`, `birth`, `gender`, `status`, `city`, `salt`, `password`, `username`, `create_time`, `avatar`)
VALUES
	(NULL,'zhao',NULL,NULL,0,NULL,'1517134883545','0f92f2c1e04431ae8f22992c86648d98c19c3d90ef79e70edefa1c96cf99722c','buynow','2018-01-29 15:02:41','http://localhost:9528/static/images/avatar/default-avatar.jpg'),
	(NULL,'zhao',NULL,1,0,'changsha','1516953677817','ac439b2a1b74e728f6a7ff34be3329d6a78a4d014489d4d1b798213233cb75ec','zhaoyuening','2018-01-26 16:01:36',NULL),
	(NULL,'zhao',NULL,NULL,0,NULL,'1516960175517','21e6056bcbd02e407b1e71d38fd8de52e50c697854dcdfa56cae8edd8320d498','zhaozhaozhao','2018-01-26 17:49:40',NULL),
	(NULL,'zhao',NULL,NULL,0,NULL,'1516962010803','438de76e78b8cc4dffbbedcd85ee8c64cefe80b4294e518cada9d1cdf1cae9d7','zhaozhaozhao2','2018-01-26 18:20:10',NULL);
